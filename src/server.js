...
app.use(
  session({
    store: MongoStore.create({
      mongoUrl:
        'mongodb+srv://admin:D4Z3hFdGnvWTasOm@techwearclubar.xtw4azf.mongodb.net/sessions?retryWrites=true&w=majority',
...
connectedServer.on(
    'error', error => console.log(`Error en el server : ${error}`)
)